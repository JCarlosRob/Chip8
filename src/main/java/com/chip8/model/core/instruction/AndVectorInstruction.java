...
@Component
public class AndVectorInstruction extends InstructionAbstract {
    ...
    @Autowired
    public AndVectorInstruction(final VectorRegister vectorXRegister, final VectorRegister vectorYRegister) {
        super(COMMAND_REGEX);
