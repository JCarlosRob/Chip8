...
public class SubtractVectorIntoVectorWithCarryInstruction extends InstructionAbstract {
    ...
    @Autowired
    public SubtractVectorIntoVectorWithCarryInstruction(final VectorRegister vectorXRegister, final VectorRegister vectorYRegister) {
        super(COMMAND_REGEX);
    ...
    public void execute(final String data) {
        ...
        this.vectorXRegister.setVRegister(15, vx > vy ? 1 : 0);
    }
}