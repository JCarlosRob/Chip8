...
class AndVectorInstructionTest {
    ...
    @BeforeEach
    void setUp() {
        this.orVectorInstruction = new AndVectorInstruction(this.vectorXRegister, this.vectorYRegister);
    }
    ...
    void isExecutable_inputCommand_returnTrue_test() {
        Assertions.assertTrue(this.orVectorInstruction.isExecutable("8FF2"));
    }
